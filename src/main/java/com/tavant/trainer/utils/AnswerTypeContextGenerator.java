...
/**
 * Identify the features of the question by leveraging Wordnet and using the
 * parse of the question and the question word (how, why, what, etc.) to output
 * a context, which is the set of features that can be passed to the model. Can
 * use Wordnet to examine what words are also predictive by looking at the
 * synsets.
 *
...
public class AnswerTypeContextGenerator {
	 ...
	 *
	 * @param dictDir
	 *            The dict directory under the wordnet dir
	 */
