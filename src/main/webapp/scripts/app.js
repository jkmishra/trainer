...
angular
  ...
  .config(['$stateProvider','$urlRouterProvider','$ocLazyLoadProvider',function ($stateProvider,$urlRouterProvider,$ocLazyLoadProvider) {
    ...
    $stateProvider
      ...
      templateUrl:'views/calculate/entity-training.html',
      url:'/training/:type',
      ...
      resolve: {
        loadMyFiles:function($ocLazyLoad) {
          return $ocLazyLoad.load({
            ...
            'scripts/controllers/entityController.js',
            ]
          })
        }
      }
    ...
    .state('dashboard.testing',{
      templateUrl:'views/calculate/entity-testing.html',
      url:'/testing/:type',
      controller: 'entityTestingController',
      resolve: {
        loadMyFiles:function($ocLazyLoad) {
          return $ocLazyLoad.load({
            name:'sbAdminApp',
            files:[
            'scripts/services/testApplicationService.js',
            'scripts/controllers/entityTestingController.js',
            ]
          })
        }
      }
